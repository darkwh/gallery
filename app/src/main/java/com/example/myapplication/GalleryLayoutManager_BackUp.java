...
public class GalleryLayoutManager_BackUp extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public GalleryLayoutManager_BackUp(int orientation) {
    ...
    /**
     * Layout the item view witch position specified by {@link GalleryLayoutManager_BackUp#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    /**
     * Layout the item view witch position special by {@link GalleryLayoutManager_BackUp#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    private float calculateToCenterFraction(View child, float pendingOffset) {
        ...
        int childLength = mOrientation == GalleryLayoutManager_BackUp.HORIZONTAL ? child.getWidth() : child.getHeight();
    ...
    private int calculateDistanceCenter(View child, float pendingOffset) {
        ...
        if (mOrientation == GalleryLayoutManager_BackUp.HORIZONTAL) {
    ...
    public interface ItemTransformer {
         ...
         */
        void transformItem(GalleryLayoutManager_BackUp layoutManager, View item, float fraction);
    }
    ...
    /**
     * Implement to support {@link GalleryLayoutManager_BackUp#smoothScrollToPosition(RecyclerView, RecyclerView.State, int)}
     */
