...
public class GalleryLayoutManager11 extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public GalleryLayoutManager11(int orientation) {
...
//        }
    ...
    /**
     * Layout the item view witch position specified by {@link GalleryLayoutManager11#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
    ...
    /**
     * Layout the item view witch position special by {@link GalleryLayoutManager11#mInitialSelectedPosition} first and then layout the other
     *
     * @param recycler
     * @param state
     */
...
//        }
    ...
    private float calculateToCenterFraction(View child, float pendingOffset) {
        ...
        int childLength = mOrientation == GalleryLayoutManager11.HORIZONTAL ? child.getWidth() : child.getHeight();
    ...
    private int calculateDistanceCenter(View child, float pendingOffset) {
        ...
        if (mOrientation == GalleryLayoutManager11.HORIZONTAL) {
    ...
    public interface ItemTransformer {
         ...
         */
        void transformItem(GalleryLayoutManager11 layoutManager, View item, float fraction);
    }
    ...
    /**
     * Implement to support {@link GalleryLayoutManager11#smoothScrollToPosition(RecyclerView, RecyclerView.State, int)}
     */
